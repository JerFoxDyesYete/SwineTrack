...
- Device enforces separate cooldowns: 5 minutes for scheduled periodic snapshots (`PERIODIC_SNAPSHOT_COOLDOWN_MS`) and 1 minute for detection-triggered alerts (`DETECTION_SNAPSHOT_COOLDOWN_MS`).
